...
'''pytesseract.pytesseract.tesseract_cmd =r"C:\BEIA\MRZ_Passport_Reader_From_Image-main\Tesseract-OCR\tesseract.exe"
text_recognition=TextRecognition("mrz+OCRB")

mrz=text_recognition.recognize("C:\BEIA\Razvan.jpg")'''
